...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"券种核销","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
var _system = _interopRequireDefault(__webpack_require__(/*! ./system */ 53));
/**
 * stores
 */
var _default = {
...
var _user = __webpack_require__(/*! @/apis/api/modules/user */ 52);
var userModule = {
  namespaced: true,
  state: {
    userData: null,
  ...
  mutations: {
    ...
    updateconfigDetail: function updateconfigDetail(state, info) {
...
var _config = __webpack_require__(/*! @/config */ 44);
var _request = _interopRequireDefault(__webpack_require__(/*! @/frame/utils/request */ 50));
...
var _storage = _interopRequireDefault(__webpack_require__(/*! ./storage */ 51));
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? ownKeys(Object(source), !0).forEach(function (key) { (0, _defineProperty2.default)(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
...
exports.getUserInfo = exports.UserInfoAjax = exports.LoginAjax = void 0;
var _regenerator = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/regenerator */ 31));
var _asyncToGenerator2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/asyncToGenerator */ 33));
var _ = __webpack_require__(/*! .. */ 49);
var LoginAjax = function LoginAjax(data, config) {
  return _.api.post('connect/token', data, config);
};
// 获取用户数据接口
exports.LoginAjax = LoginAjax;
var UserInfoAjax = function UserInfoAjax(data, config) {
  return _.api.get('/api/User/Info', data, config);
};
// // 获取用户数据接口
...
// }
// 获取用户数据
exports.UserInfoAjax = UserInfoAjax;
...
exports.ReceiveCouponAjax = exports.GetOrderPayAjax = exports.GetNeayShopAjax = exports.GetMyCouponAjax = exports.GetHomeInfoAjax = exports.GetCreateBuyLandOrderAjax = exports.GetCouponShopAjax = void 0;
var _ = __webpack_require__(/*! .. */ 49);
/**
 * 创建订单
 */
var GetCreateBuyLandOrderAjax = function GetCreateBuyLandOrderAjax(data, config) {
  return _.api.get('/api/Order/CreateBuyLandOrder', data, config);
};
/**
 * 订单支付
 */
exports.GetCreateBuyLandOrderAjax = GetCreateBuyLandOrderAjax;
var GetOrderPayAjax = function GetOrderPayAjax(data, config) {
  return _.api.get('/api/Order/OrderPay', data, config);
};
/**
 * 获取首页信息
 */
exports.GetOrderPayAjax = GetOrderPayAjax;
var GetHomeInfoAjax = function GetHomeInfoAjax(data, config) {
  return _.api.post('/api/Home/Info', data, config);
};
/**
 * 获取个人卡券
 */
exports.GetHomeInfoAjax = GetHomeInfoAjax;
var GetMyCouponAjax = function GetMyCouponAjax(data, config) {
  return _.api.post('/api/Home/MyCoupon', data, config);
};
/**
 * 获取店铺信息
 */
exports.GetMyCouponAjax = GetMyCouponAjax;
var GetNeayShopAjax = function GetNeayShopAjax(data, config) {
  return _.api.post('/api/Home/NearbyShop', data, config);
};
/**
 * 获取卡券店铺信息
 */
exports.GetNeayShopAjax = GetNeayShopAjax;
var GetCouponShopAjax = function GetCouponShopAjax(data, config) {
  return _.api.post('/api/Home/GetShopByCoupon', data, config);
};
/**
 * 获取首页信息
 */
exports.GetCouponShopAjax = GetCouponShopAjax;
var ReceiveCouponAjax = function ReceiveCouponAjax(data, config) {
  return _.api.get('/api/Home/ReceiveCoupon', data, config);
};
exports.ReceiveCouponAjax = ReceiveCouponAjax;
...
exports.WorkStatusEnum = exports.HarvestStatusEnum = exports.CouponTypeEnum = exports.CouponStatusEnum = void 0;
/**
 * 劳作状态枚举
 */
var WorkStatusEnum;
exports.WorkStatusEnum = WorkStatusEnum;
(function (WorkStatusEnum) {
  WorkStatusEnum[WorkStatusEnum["\u5168\u90E8"] = 0] = "\u5168\u90E8";
  WorkStatusEnum[WorkStatusEnum["\u5F85\u4ED8\u6B3E"] = 1] = "\u5F85\u4ED8\u6B3E";
  WorkStatusEnum[WorkStatusEnum["\u4EE3\u52B3\u505A"] = 2] = "\u4EE3\u52B3\u505A";
  WorkStatusEnum[WorkStatusEnum["\u5F85\u8BC4\u4EF7"] = 3] = "\u5F85\u8BC4\u4EF7";
  WorkStatusEnum[WorkStatusEnum["\u5DF2\u5B8C\u6210"] = 4] = "\u5DF2\u5B8C\u6210";
})(WorkStatusEnum || (exports.WorkStatusEnum = WorkStatusEnum = {}));
/**
 * 收获订单状态枚举
 */
var HarvestStatusEnum;
exports.HarvestStatusEnum = HarvestStatusEnum;
(function (HarvestStatusEnum) {
  HarvestStatusEnum[HarvestStatusEnum["\u5168\u90E8"] = 0] = "\u5168\u90E8";
  HarvestStatusEnum[HarvestStatusEnum["\u5F85\u6536\u83B7"] = 1] = "\u5F85\u6536\u83B7";
  HarvestStatusEnum[HarvestStatusEnum["\u5F85\u8BC4\u4EF7"] = 2] = "\u5F85\u8BC4\u4EF7";
  HarvestStatusEnum[HarvestStatusEnum["\u5DF2\u5B8C\u6210"] = 3] = "\u5DF2\u5B8C\u6210";
})(HarvestStatusEnum || (exports.HarvestStatusEnum = HarvestStatusEnum = {}));
/**
 * 卡券类型
 */
var CouponTypeEnum;
...
(function (CouponTypeEnum) {
  CouponTypeEnum[CouponTypeEnum["\u5168\u90E8"] = -1] = "\u5168\u90E8";
  CouponTypeEnum[CouponTypeEnum["\u62B5\u6263\u5238"] = 0] = "\u62B5\u6263\u5238";
  CouponTypeEnum[CouponTypeEnum["\u6298\u6263\u5238"] = 1] = "\u6298\u6263\u5238";
  CouponTypeEnum[CouponTypeEnum["\u6EE1\u51CF\u5238"] = 2] = "\u6EE1\u51CF\u5238";
...
(function (CouponStatusEnum) {
  CouponStatusEnum[CouponStatusEnum["\u5F85\u4F7F\u7528"] = 0] = "\u5F85\u4F7F\u7528";
  CouponStatusEnum[CouponStatusEnum["\u5DF2\u4F7F\u7528"] = 1] = "\u5DF2\u4F7F\u7528";
  CouponStatusEnum[CouponStatusEnum["\u5DF2\u8FC7\u671F"] = 2] = "\u5DF2\u8FC7\u671F";
...
exports.PostUpdateImageToServiceAjax = exports.PostUpdateForImageAjax = exports.PostAuthLoginAjax = exports.GetWxTokenAndTicketAjax = exports.GetUserInfoAjax = exports.GetUpdateForNameAjax = exports.GetOpenIDByCodeAjax = exports.GetImageUrlAjax = exports.GetDecryptPhoneAjax = void 0;
var _ = __webpack_require__(/*! .. */ 49);
/**
 * 获取全局会话令牌
 */
var GetWxTokenAndTicketAjax = function GetWxTokenAndTicketAjax(data, config) {
  return _.api.get('/api/User/GetWxTokenAndTicket', data, config);
};
/**
 * 小程序获取openid
 */
exports.GetWxTokenAndTicketAjax = GetWxTokenAndTicketAjax;
var GetOpenIDByCodeAjax = function GetOpenIDByCodeAjax(data, config) {
  return _.api.get('/api/User/GetOpenIDByCode', data, config);
};
/**
 * 微信小程序授权注册登录
 */
exports.GetOpenIDByCodeAjax = GetOpenIDByCodeAjax;
var PostAuthLoginAjax = function PostAuthLoginAjax(data, config) {
  return _.api.post('/api/User/AuthLogin', data, config);
};
/**
 * 微信小程序获取解密手机号码
 */
exports.PostAuthLoginAjax = PostAuthLoginAjax;
var GetDecryptPhoneAjax = function GetDecryptPhoneAjax(data, config) {
  return _.api.get('/api/User/DecryptPhone', data, config);
};
/**
 * 获取个人信息
 */
exports.GetDecryptPhoneAjax = GetDecryptPhoneAjax;
var GetUserInfoAjax = function GetUserInfoAjax(data, config) {
  return _.api.get('/api/User/Info', data, config);
};
/**
 * 修改头像
 */
exports.GetUserInfoAjax = GetUserInfoAjax;
var PostUpdateForImageAjax = function PostUpdateForImageAjax(data, config) {
  return _.api.post('/api/User/UpdateForImage', data, config);
};
/**
 * 修改昵称
 */
exports.PostUpdateForImageAjax = PostUpdateForImageAjax;
var GetUpdateForNameAjax = function GetUpdateForNameAjax(data, config) {
  return _.api.get('/api/User/UpdateForName', data, config);
};
/**
 * 上传头像
 */
exports.GetUpdateForNameAjax = GetUpdateForNameAjax;
var PostUpdateImageToServiceAjax = function PostUpdateImageToServiceAjax(data, config) {
  return _.api.post('/api/User/UpdateImageToService', data, config);
};
/**
 * 查询上传头像地址
 */
exports.PostUpdateImageToServiceAjax = PostUpdateImageToServiceAjax;
var GetImageUrlAjax = function GetImageUrlAjax(data, config) {
  return _.api.get('/api/User/GetImageUrl', data, config);
};
exports.GetImageUrlAjax = GetImageUrlAjax;
...
var ListPage = /*#__PURE__*/(0, _createClass2.default)(function ListPage(config) {
  ...
  var processFn = config.process;
  var getList = config.getList;
    ...
    getPageList: function getPageList(isRemoveList) {
      ...
      return _promiseApi(requestData, configData).then(function (res) {
        if (res.statusCode === 200) {
          typeof processFn === 'function' && processFn.call(_this, res);
          var list = isRemoveList ? [] : table.list || [];
          var resList = typeof getList === 'function' ? getList.call(_this, res.data.Result) : res.data.Result[filedMaps.list] || [];
          var resData = _this._processFn(resList).map(function (item) {
