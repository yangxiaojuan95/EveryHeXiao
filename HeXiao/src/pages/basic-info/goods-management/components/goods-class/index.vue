...
const delCurrentType = async () => {
  ...
  if (currentNode.value.childs?.length) {
    ...
    await processdRequest.post('/api/BackGoods/DelClass', {
      IdList: [currentNode.value.ClassID],
    })
  ...
  <div class="goods-types">
    ...
    <div class="goods-types__list">
      <side-tree
        ...
        method="get"
        api="/api/BackGoods/GetClassList"
        :tree-props="{
          label: 'ClassName',
          value: 'Id',
          pId: 'pId',
    ...
    <goods-form ref="goodsTypesRef" @submit-success="onSubmitSuccess" />
  </div>
</template>
