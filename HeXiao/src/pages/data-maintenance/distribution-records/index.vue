...
;(async () => {
  const result = await processdRequest.get(
    '/api/BackRecords/GetCouponAndThemeDto'
  )
    ...
    els: [
      {
        ...
        renderFn(row) {
          ...
          return (
            <RecordsList
              propd={row.RecordsList || reflections.coupList}
              data={reflections.CouponList}
              modelValue={row.RecordsList || reflections.coupList}
              onUpdata:modelValue={onUpdataModelValue}
            ></RecordsList>
          )
        },
        col: {
      ...
      },
      {
        ...
        renderFn(row) {
          ...
          return (
            <BgTheme
              data={reflections.ThemeDto}
              bgList={reflections.bgList}
