    ...
    els: [
      {
        ...
        label: '图片',
        renderFn(row) {
          return <el-image style={{width: '100px'}} src={`${pathUrl}${row.BackgroundTheme}`}/>
        }
      },
      {
        prop: 'Name',
    ...
    els: [
      {
        ...
        renderFn(row) {
          ...
          return <UploadImg modelValue={row.BackgroundTheme} mult={false} onUpdate:modelValue={onUpload} />
        },
    ...
    <div class="img">
      <div class="box" >
        ...
        <!-- <img-upload v-model="userIcon"></img-upload> -->
          <UploadImg :modelValue="userIcon" :mult="false" @Update:modelValue={onUpload} />
        </el-form-item>
        <el-button class="button" type="primary" @click="handleClick">确认更换</el-button>
      </div>
